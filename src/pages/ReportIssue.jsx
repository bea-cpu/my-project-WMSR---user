...
import {
  ...
  FaRegCalendarAlt, FaWrench, FaSkullCrossbones, FaCheck, FaFileUpload,
  FaFileAlt
} from 'react-icons/fa';
...
function ReportIssue() {
  ...
  const handleSubmit = (event) => {
    ...
    setTimeout(() => {
      console.log('Form Submitted!', { selectedIssue, priority, location, description, files, name, phone, email });
    ...
    <div className="page-container">
      ...
      <div className="emergency-box">
        <div className="emergency-header">
          ...
          <h3 className="emergency-title">Emergency Situations</h3>
        </div>
